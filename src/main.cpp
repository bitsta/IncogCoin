...
const string strMessageMagic = "IncogCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 3 * 30;  // 3 blocks
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IncogCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This is IncogCoin the only truly anonymous crypto out there.7/20";
        CTransaction txNew;
        txNew.nTime = 1405848818;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x01366329607e5a81e1b011585b4bebe0f5df2febca9b54958a0411a73c7581112"));
        block.print();
